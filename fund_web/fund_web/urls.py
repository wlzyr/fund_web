...
urlpatterns = [
    ...
    path('index/', views.main.as_view(), name="index"),
    path('config/', views.config.as_view(), name="config"),
    path('week_data/', views.week_data.as_view(), name="week_data"),
    path('sum_data/', views.sum_data.as_view(), name="sum_data"),
    path('fund_inf/', views.fund_inf.as_view(), name="fund_inf"),
